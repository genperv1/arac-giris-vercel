...
function printHistoryListColumns(slim) {
  const cols = 'id, plaka, firma, malzeme, tonaj, basim_yeri, sevkiyat_id, sofor, sevk_yeri, yukleme_turu, iletisim, tc_kimlik, dorse_plaka, vehicle_id, tarih';
  return slim ? cols : cols + ', snapshot';
}
