      ...
      location.href = 'rapor.html';
            ...
            document.getElementById('excelClearButtonTop')?.addEventListener('click', async function(){
                ...
                if (typeof removeDailyShipmentsByBlocks === 'function') {
                    r = await removeDailyShipmentsByBlocks(selectedBlocks);
                } else {
...
async function validateToken() {
  ...
  try {
    if (window.SessionManager && typeof window.SessionManager.invalidateSession === 'function') {
      window.SessionManager.invalidateSession();
    } else if (window.SessionManager && typeof window.SessionManager.stopSessionKeepAlive === 'function') {
      window.SessionManager.stopSessionKeepAlive();
    }
  } catch (e) {}
...
function startSessionMonitoring() {
  ...
  sessionCheckInterval = setInterval(async () => {
    ...
    if (window.SessionManager && typeof window.SessionManager.checkSessionValidity === 'function') {
      try {
